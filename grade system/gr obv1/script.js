...
var occupancyRate = 20; // Initial occupancy rate in percentage
...
function bookTickets() {
    ...
    var newOccupancyRate = Math.min(100, occupancyRate + ticketCount * 4); // Assuming each ticket adds 4% occupancy
