...
let occupancyRate: number = 20; // Initial occupancy rate in percentage
...
function bookTickets() {
  ...
  const newOccupancyRate = Math.min(100, occupancyRate + ticketCount * 4); // Assuming each ticket adds 4% occupancy
